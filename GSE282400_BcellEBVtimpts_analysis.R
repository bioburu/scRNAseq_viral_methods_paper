...
data<-readRDS(file='/home/em/Desktop/my_files/b_cells_analysis/B_cell_EBV_tmpts_methods/GSE282400_BcellEBV_viralpanel.rda')
...
ebv1<-read.csv('/home/em/Desktop/my_files/b_cells_analysis/B_cell_EBV_tmpts_methods/genes/ebv_genes.csv')
ebv1<-ebv1$x
...
ebv2<-read.csv('/home/em/Desktop/my_files/b_cells_analysis/B_cell_EBV_tmpts_methods/genes/ebv2_genes.csv')
ebv2<-ebv2$x
...
hervk113<-read.csv('/home/em/Desktop/my_files/b_cells_analysis/B_cell_EBV_tmpts_methods/genes/HERVK113_sequence.csv')
hervk113<-hervk113$x
hervk113

sv40<-read.csv('/home/em/Desktop/my_files/b_cells_analysis/B_cell_EBV_tmpts_methods/genes/SV40_sequence.csv')
sv40<-sv40$x
sv40

stxPhagevB<-read.csv('/home/em/Desktop/my_files/b_cells_analysis/B_cell_EBV_tmpts_methods/genes/stxPhage_sequence.csv')
